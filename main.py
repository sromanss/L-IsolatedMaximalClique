...
for _ in range(numero_ripetizioni):                                                             # Ripeti le esecuzioni tante volte quanto indicato nella variabile numero_ripetizioni
    ...
    cliques_isolated = alg.trova_clique_massimali_L_isolated2(G, L, euristica)                 # e = 1 -> D = len(P); e = 2 -> D = 1 + grado_massimo_sottografoDiP; e = 3 -> D = maxGradiOrdinati
...
print(f"Numero medio di chiamate ricorsive: {chiamata_ricorsive_medie: .2f}")
