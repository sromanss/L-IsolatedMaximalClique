...
# Salva time prima di fare la ricerca delle clique massimali
start1 = time.time()
...
# Salva time dopo aver fatto la ricerca delle clique
end1 = time.time()
...
# Salva time prima di fare la ricerca delle clique massimali L-isolated
start2 = time.time()
...
print("\nTempo di esecuzione dell'algoritmo di ricerca:", end1-start1, "secondi")

# Stampa il tempo di esecuzione dell'algoritmo di filtro
print("\nTempo di esecuzione dell'algoritmo di filtro:", end2-start2, "secondi")
